...
import { Alert, Button, Linking, StyleSheet, View, Text,Image } from "react-native";
import { TouchableOpacity } from "react-native-gesture-handler";

function ArticleLink({x,i}) {
    ...
    return (
        <TouchableOpacity key={i} style={styles.card} onPress = {handlePress} >
